...
def find_peak_values(gpu_data, peak_values, timestamp):
    for gpu_data in gpu_data:
        ...
        metrics['Temperature']['Day'][gpu_index].append(temperature)  # Adicionar o valor à lista
        metrics['Temperature']['Week'][gpu_index].append(temperature)  # Adicionar o valor à lista
