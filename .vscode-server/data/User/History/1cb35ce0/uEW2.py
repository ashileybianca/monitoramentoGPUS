...
def find_peak_values(gpu_data, peak_values, timestamp):
    ...
    for gpu_info in gpu_data:
        ...
        if len(metrics['Power Draw']['Hour'][gpu_index]) <= 3:
            last_hour_pw = metrics['Power Draw']['Hour'][gpu_index][-3:]
        ...
        if len(metrics['Power Draw']['Hour'][gpu_index]) <= 5:
            last_day_pw = metrics['Power Draw']['Hour'][gpu_index][-5:]
        ...
        if len(metrics['Power Draw']['Hour'][gpu_index]) <= 10:
            last_week_pw = metrics['Power Draw']['Hour'][gpu_index][-10:]
